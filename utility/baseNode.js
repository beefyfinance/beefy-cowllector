...
exports.swapKeyValues =
  exports.nodeJsError =
  exports.settledPromiseFilled =
  exports.settledPromiseRejected =
    void 0;
...
const swapKeyValues = (obj, numeric) =>
  Object.fromEntries(
    Object.entries(obj).map(([key, value]) => [value, numeric ? parseInt(key) : key])
  );
