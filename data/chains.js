...
const chains = {
  56: {
    ...
    wnativeMinToUnwrap: String(process.env.BSC_WNATIVE_MIN_TO_UNWRAP) || '0.1',
  ...
  128: {
    ...
    wnativeMinToUnwrap: String(process.env.HECO_WNATIVE_MIN_TO_UNWRAP) || '0.1',
  ...
  43114: {
    ...
    wnativeUnwrapInterval: 8,
    wnativeMinToUnwrap: String(process.env.AVAX_WNATIVE_MIN_TO_UNWRAP) || '0.1',
  ...
  137: {
    ...
    wnativeUnwrapInterval: 4,
    wnativeMinToUnwrap: String(process.env.POLYGON_WNATIVE_MIN_TO_UNWRAP) || '0.1',
  ...
  250: {
    ...
    wnativeUnwrapInterval: 4,
    wnativeMinToUnwrap: String(process.env.FANTOM_WNATIVE_MIN_TO_UNWRAP) || '0.1',
  ...
  1666600000: {
    ...
    wnativeUnwrapInterval: 4,
    wnativeMinToUnwrap: String(process.env.ONE_WNATIVE_MIN_TO_UNWRAP) || '0.1',
  ...
  42161: {
    ...
    wnativeMinToUnwrap: String(process.env.ARBITRUM_WNATIVE_MIN_TO_UNWRAP) || '0.1',
  ...
  42220: {
    ...
    wnativeMinToUnwrap: String(process.env.CELO_WNATIVE_MIN_TO_UNWRAP) || '0.1',
  ...
  1285: {
    ...
    wnativeMinToUnwrap: String(process.env.MOONRIVER_WNATIVE_MIN_TO_UNWRAP) || '0.1',
  ...
  25: {
    ...
    wnativeUnwrapInterval: 6,
    wnativeMinToUnwrap: String(process.env.CRONOS_WNATIVE_MIN_TO_UNWRAP) || '0.1',
  ...
  122: {
    ...
    wnativeUnwrapInterval: 6,
    wnativeMinToUnwrap: String(process.env.FUSE_WNATIVE_MIN_TO_UNWRAP) || '0.1',
  ...
  1088: {
    ...
    wnativeUnwrapInterval: 6,
    wnativeMinToUnwrap: String(process.env.METIS_WNATIVE_MIN_TO_UNWRAP) || '0.1',
  ...
  1313161554: {
    ...
    wnativeUnwrapInterval: 8,
    wnativeMinToUnwrap: String(process.env.AURORA_WNATIVE_MIN_TO_UNWRAP) || '0.1',
    rpc:
